<?php
    ...
    if($_SESSION == null || $varsesion=''){
        echo 'No puedes acceder al sitio de esta forma';
        die();
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>MANAGE_UTN | Movilidad</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
                    class="fa-solid fa-user-gear me-2"></i>UTNADMIN</div>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="./Login.php" id="navbarDropdown"
                                ...
                                <i class="fas fa-user me-2"></i>Dpto.Movilidad
                            </a>
